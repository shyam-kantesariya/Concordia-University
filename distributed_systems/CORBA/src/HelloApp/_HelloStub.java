...
public class _HelloStub extends org.omg.CORBA.portable.ObjectImpl implements HelloApp.Hello {
    ...
    public String sayHello() {
        //System.out.println(this.getClass().toString() + ": sayHello");
        org.omg.CORBA.portable.InputStream $in = null;
        try {
            org.omg.CORBA.portable.OutputStream $out = _request("sayHello", true);
            $in = _invoke($out); // throws ApplicationException and RemarshalException
    ...
    private void readObject(java.io.ObjectInputStream s) throws java.io.IOException {
        //System.out.println(this.getClass().toString() + ": readObject");
    ...
    private void writeObject(java.io.ObjectOutputStream s) throws java.io.IOException {
        //System.out.println(this.getClass().toString() + ": writeObject");
        String[] args = null;
        java.util.Properties props = null;
        org.omg.CORBA.ORB orb = org.omg.CORBA.ORB.init(args, props);
        try {
